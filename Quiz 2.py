# this adds points and tells you the right aner if you got it wrong
Win = "Correct +1"
Lose = "Wrong it was"
score = 0
birthday = 0
...
#This adds a system that calculates the users age by asking if they have had there bday then asking for there year of birth
#then doing some maths to figure out there age
...
#this a title for the quiz it tells the user what the quiz is about
print("Welcome to my Fortnite quiz!")
print()


#this is a start button it tells the user to start
start = input("Press enter to start...")
if start == "":
    print("")
else:
    print("")
#The question is asked then the user has to answer them if they get it wrong it will tell you the right answer
# or gives them 1 score if they get it right
...
#this tells the user that the questions after this will be more difficult
print()
...
print()
#THis shows the user how many they got right
if score == 0:
